...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/sazid-sheikh-258714283/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@yoursazidd",
    icon: Instagram,
    url: "https://www.instagram.com/yoursazidd/",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@Sazidsheikh2006",
    icon: Github,
    url: "https://github.com/sazid2006sheikh/",
    color: "#ffffff",
  ...
  },
  {
    ...
    <title>Twitter</title>
    <g id="Icon/Social/Twitter-color" stroke="none" stroke-width="8" fill="none" fill-rule="evenodd">
    ...
    url: "https://x.com/Sazidsheikh2006",
    color: "black",
